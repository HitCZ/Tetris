    ...
    class ShapeI : Shape {
        ...
        protected override void ChangeRotationToDefault() {
            ...
            this.ComposedShape = new Block[4, 4]
            {
                ...
                { this.Part2, null, null, null },
                { this.Part3, null, null, null },
            ...
            this.Part4.Row = this.Part1.Row + 3;
        ...
        protected override void ChangeRotationToRotatedOnce() {
            ...
            this.Part4.Row = this.Part1.Row;
            this.Part4.Column = this.Part1.Column + 3;
        }
        ...
        protected override void ChangeRotationToRotatedThreeTimes() {
            ...
            this.Part1.Row = this.Row + 3;
            this.Part1.Column = this.Column - 3;
